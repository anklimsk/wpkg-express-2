...
/**
 * The model is used to manage packages inclusions.
 *
 * @package app.Model
 */
class PackagesInclude extends AppModel {
	...
	public $hasMany = [
		'Attribute' => [
			...
			'conditions' => [
				...
				'Attribute.ref_node' => ATTRIBUTE_NODE_INCLUDE
			],
			'fields' => [
...
/**
 * Return array for render package inclusions XML elements
 *
 * @param array $data Information of package inclusions
 ...
 */
	public function getNameExt($id = null, $typeName = null, $primary = true) {
		$format = __('inclusion %s of the %s');
