...
/**
 * The model is used to manage package execute types.
 *
 * @package app.Model
 */
class PackageExecuteType extends AppModel {
 ...
 */
	public $actsAs = [
		'GetList' => ['cacheConfig' => CACHE_KEY_LISTS_INFO_PACKAGE_EXECUTE_TYPE],
		'InitDBdata' => [
			'constantPrefix' => 'PACKAGE_EXECUTE_',
			'toLowerCase' => true
		]
	];
	...
	public $validate = [
		'name' => [
			'notBlank' => [
				...
				'required' => true,
				'allowEmpty' => false,
				'message' => 'The execute type is invalid.',
				'last' => true
			],
			'isUnique' => [
				'rule' => 'isUnique',
				'message' => 'The execute type already exists.',
				'last' => true
			],
		]
	];
 ...
 *
 * Actions:
 *  - Convert execute type to lowercase.
 *
...
/**
 * Return list of package execute types
 *
 * @return array Return list of package execute types
 */
	public function getListPackageExecuteTypes() {
		return $this->getList(null, 'package_execute', null, null, true);
	}
}
