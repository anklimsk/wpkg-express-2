...
/**
 * The model is used to manage package reboot types.
 *
 * @package app.Model
 */
class PackageRebootType extends AppModel {
 ...
 */
	public $actsAs = [
		'GetList' => ['cacheConfig' => CACHE_KEY_LISTS_INFO_PACKAGE_REBOOT_TYPE],
		'InitDBdata' => [
			'constantPrefix' => 'PACKAGE_REBOOT_',
			'toLowerCase' => true
		]
	];
 ...
 *
 * Actions:
 *  - Convert reboot type to lowercase.
 *
...
/**
 * Return list of package reboot types
 *
 * @return array Return list of package reboot types
 */
	public function getListPackageRebootTypes() {
		return $this->getList(null, 'package_reboot', null, null, true);
	}
}
