...
/**
 * The model is used to manage dependencies packages.
 *
 * @package app.Model
 */
class PackagesPackage extends AppModel {
...
/**
 * Return array for render package dependencies XML elements
 *
 ...
 */
	public function getXMLdata($data = []) {
		return $this->getDependsXMLdata($data, 'package-id', 'depends');
	}
 ...
 */
	public function getBreadcrumbInfo($id = null, $refType = null, $refNode = null, $refId = null, $includeRoot = null) {
		$label = __('Dependency of package');
