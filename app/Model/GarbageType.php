...
/**
 * The model is used to manage data types for garbage.
 *
 * @package app.Model
 */
class GarbageType extends AppModel {
 ...
 */
	public $actsAs = [
		'GetList' => ['cacheConfig' => CACHE_KEY_LISTS_INFO_GARBAGE_TYPE],
		'InitDBdata' => ['constantPrefix' => 'GARBAGE_TYPE_']
	];
...
/**
 * Return list of garbage types
 *
 * @return array Return list of garbage types
 */
	public function getListGarbageTypes() {
		return $this->getList(null, 'garbage');
	}
