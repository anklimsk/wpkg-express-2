...
*
*/
Cache::config(CACHE_KEY_MODEL_CFG_INFO, [
	'engine' => 'File',
	'prefix' => 'wpkg_',
	'duration' => '+1 week',
	'probability' => 100,
	'path' => CACHE . CACHE_KEY_MODEL_CFG_INFO . DS,
]);
...
*
*/
$listCacheConfigs = constsVals('CACHE_KEY_STATISTICS_INFO');
foreach ($listCacheConfigs as $cacheConfig) {
	Cache::config($cacheConfig, [
		'engine' => 'File',
		'prefix' => 'wpkg_',
		'duration' => '+1 week',
		'probability' => 100,
		'path' => CACHE . $cacheConfig . DS,
	]);
}

/**
* Configuration the cache for store lists information
*
*/
$listCacheConfigs = constsVals('CACHE_KEY_LISTS_INFO');
foreach ($listCacheConfigs as $cacheConfig) {
	Cache::config($cacheConfig, [
		'engine' => 'File',
		'prefix' => 'wpkg_',
