...
/**
 * This task is used for parse log files in the queue.
 *
 * @package app.Console.Command.Task
 */
class QueueParseLogsTask extends AppShell {
 ...
 * @var int
 */
	public $timeout = LOG_PARSE_TIME_LIMIT;
 ...
 */
	public function run($data, $id = null) {
		$this->hr();
		$this->out(__('CakePHP Queue task for parsing log files.'));
		...
		$data += $dataDefault;
		extract($data);
		$this->Log->parseLogs($hostName, $id);
