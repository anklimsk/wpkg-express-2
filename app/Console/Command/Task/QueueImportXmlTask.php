...
/**
 * This task is used for import XML file in the queue.
 *
 * @package app.Console.Command.Task
 */
class QueueImportXmlTask extends AppShell {
 ...
 * @var int
 */
	public $timeout = TASK_IMPORT_XML_TIME_LIMIT;
 ...
 */
	public function run($data, $id = null) {
		$this->hr();
		$this->out(__('CakePHP Queue task for import XML file.'));
		...
		$this->Import->importXml($fileName, $id);
